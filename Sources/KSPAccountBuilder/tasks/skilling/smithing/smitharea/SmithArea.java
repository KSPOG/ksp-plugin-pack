...
public enum SmithArea {
    SMITH_AREA_VARROCK_WEST_ANVIL("Varrock West Anvil", new WorldPoint(3185, 3427, 0), new WorldPoint(3190, 3423, 0));

    private final String displayName;
    private final WorldPoint southWest;
    private final WorldPoint northEast;

    private SmithArea(String displayName, WorldPoint firstCorner, WorldPoint secondCorner) {
